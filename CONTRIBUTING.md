Contributions to **aws.alexa** are welcome from anyone and are best sent as pull requests on [the GitHub repository](https://github.com/cloudyr/aws.alexa/). This page provides some instructions to potential contributors about how to add to the package.

 1. Contributions can be submitted as [a pull request](https://help.github.com/articles/creating-a-pull-request/) on GitHub by forking or cloning the [repo](https://github.com/cloudyr/aws.alexa/), making changes and submitting the pull request.
 ...
 5. Non-trivial contributions need to be noted in the `Authors@R` field in the [DESCRIPTION](https://github.com/cloudyr/aws.alexa/blob/master/DESCRIPTION). Just follow the format of the existing entries to add your name (and, optionally, email address). Substantial contributions should also be noted in [`inst/CITATION`](https://github.com/cloudyr/aws.alexa/blob/master/inst/CITATION).
 ...
 7. Please run `R CMD BUILD aws.alexa` and `R CMD CHECK aws.alexa_VERSION.tar.gz` before submitting the pull request to check for any errors.
...
Any questions you have can be opened as GitHub issues or directed to gsood07 (at) gmail.com.
